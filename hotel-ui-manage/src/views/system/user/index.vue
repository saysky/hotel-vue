<template>
  <div class="app-container">
    ...
    <!-- 查看用户配置对话框 -->
    <el-dialog title="查看用户" :visible.sync="viewOpen" width="600px" append-to-body>
      <el-form ref="form" label-width="80px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="角色">
              <span v-for="item in roleOptions" :key="item.roleId">
                <span v-for="item2 in form.roleIds" v-if="item2 == item.roleId">
                   {{ item.roleName }}
                </span>
               </span>
            </el-form-item>
