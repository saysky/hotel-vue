package com.liuyanzhao.common.core.controller;
...
import com.liuyanzhao.common.constant.HttpStatus;
...
import com.liuyanzhao.common.utils.PageUtils;
...
public class BaseController {
    ...
    public Boolean isAdmin() {
        ...
        if ("admin".equals(loginUser.getUsername()) || permissions.contains("*:*:*")) {
            return true;
        }
        return false;
    }
